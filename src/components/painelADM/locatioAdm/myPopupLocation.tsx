        ...
        <Dialog.Content className="fixed top-[27%] md:top-[19%] left-1/2 bg-gray-800 py-6 rounded shadow transform -translate-x-1/2 -translate-y-1 text-zinc-50 w-[92%] md:w-[82rem] h-auto ">
          ...
          <div className="bg-azulBg w-80 md:w-3/5 h-full mx-auto mt-10 py-10 rounded-md ">
            <div className=" flex flex-col items-center space-y-5 ">
              ...
              <input type="text" id="Coodernada" placeholder="Coodernada" className="bg-azulBg w-72 md:w-3/5  py-2 pl-3 rounded-md border border-zinc-50 shadow-md" />
              <input type="text" id="Regiao" placeholder="Regiao" className="bg-azulBg w-72 md:w-3/5  py-2 pl-3 rounded-md border border-zinc-50 shadow-md" />

            </div>
            <div className="flex justify-center items-center mt-5 md:mt-10"> 
              <button className=" bg-blue-500  py-1 md:py-2  px-11 md:px-[8.6rem] rounded-md">
